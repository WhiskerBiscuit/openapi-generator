 ...
 */
  ...
  * TO RUN ME:
  * - mvn clean install
  * - cd out/generators/tsne
  * - mvn package
  * - cd <project-root>
  * - java -cp "out/generators/tsne/target/typescript-node-express-openapi-generator-1.0.0.jar;modules/openapi-generator-cli/target/openapi-generator-cli.jar" org.openapitools.codegen.OpenAPIGenerator generate -g typescript-node-express -i <swagger-yaml> -o <output-dir>
  */
...
public class TypescriptNodeExpressGenerator extends DefaultCodegen implements CodegenConfig {
    ...
    public TypescriptNodeExpressGenerator() {
        ...
        supportingFiles.add(new SupportingFile("expressServer.mustache", "", "ExpressServer.ts"));
        supportingFiles.add(new SupportingFile("index.mustache", "", "index.ts"));
        supportingFiles.add(new SupportingFile("logger.mustache", "", "logger.ts"));
        supportingFiles.add(new SupportingFile("eslintrc.mustache", "", ".eslintrc.json"));

        // utils folder
        supportingFiles.add(new SupportingFile("utils" + File.separator + "openapiRouter.mustache", "routers", "openapiRouter.ts"));
