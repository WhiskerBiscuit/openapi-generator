 ...
 * 1) Set a break point in TypescriptNodeExpressGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class TypescriptNodeExpressGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("typescript-node-express") // use this codegen library
              ...
              .setOutputDir("out/typescript-node-express"); // output directory
